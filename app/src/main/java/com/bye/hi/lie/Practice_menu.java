...
import com.bye.hi.lie.TestData.StudyView1;
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case R.id.checkBox1:
                        Intent intent0 = new Intent(Practice_menu.this,TestView1.class);
                        startActivity(intent0);
                        break;
                    case R.id.checkBox2:
                        Intent intent1 = new Intent(Practice_menu.this,TestView2.class);
                        startActivity(intent1);
                        break;
                    case R.id.checkBox3:
                        Intent intent2 = new Intent(Practice_menu.this,TestView3.class);
                        startActivity(intent2);
                        break;
                    case R.id.checkBox4:
                        Intent intent3 = new Intent(Practice_menu.this,StudyView1.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {                                                 //백버튼 누를시 Question
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                ...
                new AlertDialog.Builder(Practice_menu.this)
                        .setTitle(alertTitle)
                        ...
                        .setPositiveButton(buttonYes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(Practice_menu.this,MainActivity.class);
                                startActivity(intent);
                            }
                        })
